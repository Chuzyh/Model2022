...
\subsection{问题一模型的建立与求解}
  ...
  \subsubsubsection{投票机制}
    ...
    设真实的发射源为$F_0$，则当接收点$J$得到了$\angle OJF_0$和$\angle PJF_0$的角度信息后，对于每个发射源$F$，它的得票数$vote_F$可由下列式子计算得到：
\begin{equation}
    vote_F=\mathop{\Sigma}\limits_{Q} [V_{Q,I,F,Omin} \le \angle OJF_0 \le V_{Q,I,F,Omax}][V_{Q,I,F,Pmin} \le \angle PJF_0 \le V_{Q,I,F,Pmax}]
\end{equation}
